...
inline const char *EnumNameEquipment(Equipment e) {
  if (flatbuffers::IsOutRange(e, Equipment::NONE, Equipment::Gun)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct EquipmentTraits<weapons::Gun> {
  static const Equipment enum_value = Equipment::Gun;
};
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const weapons::Gun *equipped_as_Gun() const {
    return equipped_type() == MyGame::Sample::Equipment::Gun ? static_cast<const weapons::Gun *>(equipped()) : nullptr;
  }
...
template<> inline const weapons::Gun *Monster::equipped_as<weapons::Gun>() const {
  return equipped_as_Gun();
}
