...
type MonsterT struct {
	...
	Names []string
	Inventory []byte
	Color Mygame__Example.Color
	Weapons []*Mygame__Example.WeaponT
	Equipped *Mygame__Example.EquipmentT
	VectorOfUnions []*Mygame__Example.EquipmentT
	Path []*Mygame__Example.Vec3T
}
...
func (rcv *Monster) UnPackTo(t *MonsterT) {
	...
	t.Weapons = make([]*Mygame__Example.WeaponT, weaponsLength)
	...
	t.Path = make([]*Mygame__Example.Vec3T, pathLength)
...
func (rcv *Monster) Pos(obj *Mygame__Example.Vec3) *Mygame__Example.Vec3 {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
		x := o + rcv._tab.Pos
		if obj == nil {
			obj = new(Mygame__Example.Vec3)
		}
...
func (rcv *Monster) Color() Mygame__Example.Color {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(18))
	if o != 0 {
		return Mygame__Example.Color(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 2
}

func (rcv *Monster) MutateColor(n Mygame__Example.Color) bool {
...
func (rcv *Monster) EquippedType() Mygame__Example.Equipment {
	...
	if o != 0 {
		return Mygame__Example.Equipment(rcv._tab.GetByte(o + rcv._tab.Pos))
	}
	return 0
}

func (rcv *Monster) MutateEquippedType(n Mygame__Example.Equipment) bool {
...
func (rcv *Monster) VectorOfUnionsType(j int) Mygame__Example.Equipment {
	...
	if o != 0 {
		a := rcv._tab.Vector(o)
		return Mygame__Example.Equipment(rcv._tab.GetByte(a + flatbuffers.UOffsetT(j*1)))
	}
	return 0
}
...
func (rcv *Monster) Path(obj *Mygame__Example.Vec3, j int) bool {
