...
func TestCreateItemTable(t *testing.T) {
	...
	as.Equal(istt.Color(), Example.ColorGreen)
...
func FCreateItemStruct(builder *flatbuffers.StructBuffers,
	bool bool, u64 uint64, color Example.Color,
	i8 int8, f32 float32, ubyte byte) flatbuffers.VField {
	builder.Prep(8, 32)
	builder.Pad(7, 25)
